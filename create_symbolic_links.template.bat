...
if exist "%path%\_retail_" (
	...
	mklink /D "%path%\_retail_\Interface\AddOns\PackageInitialization" "%~dp0\AddOns\PackageInitialization"
...
if exist "%path%\_classic_" (
	...
	mklink /D "%path%\_classic_\Interface\AddOns\PackageInitialization" "%~dp0\AddOns\PackageInitialization"
...
if exist "%path%\_classic_era_" (
	...
	mklink /D "%path%\_classic_era_\Interface\AddOns\PackageInitialization" "%~dp0\AddOns\PackageInitialization"
